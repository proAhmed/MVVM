        ...
        publications {
            create<MavenPublication>("release") {
                ...
                pom {
                    ...
                    url.set("https://github.com/proahmed/mvvm/")
                    ...
                    scm {
                        connection.set("scm:git:git://github.com/proahmed/mvvm.git")
                        developerConnection.set("scm:git:ssh://github.com/proahmed/mvvm.git")
                        url.set("https://github.com/proahmed/mvvm/")
                    }
                    issueManagement {
                        system.set("GitHub Issues")
                        url.set("https://github.com/proahmed/mvvm/issues")
                    }
                }
            }
        }
